 ...
 * @param OnCredentialsReceived - Lambda that will be triggered after a successful
...
fun GoogleOneTapSignIn(
    ...
    clientId: String,
    nonce: String? = null,
    OnCredentialsReceived: (UserCredentials) -> Unit,
    ...
    val activityLauncher = rememberLauncherForActivityResult(
        ...
        try {
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                val googleOneTapUserCredentials = UserCredentials(
                    id = credentials.id,
                    ...
                    profilePictureUri = credentials.profilePictureUri,
                )
                OnCredentialsReceived(googleOneTapUserCredentials)
                state.close()
